...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('deepmerge'), require('jss-global'), require('jss-nested'), require('jss-camel-case'), require('jss-default-unit'), require('jss-vendor-prefixer'), require('jss-props-sort'), require('react'), require('brcast'), require('recompose/getDisplayName'), require('recompose/wrapDisplayName'), require('react-jss/lib/contextTypes'), require('jss'), require('react-jss/lib/ns'), require('react-transition-group/Transition'), require('react-dom'), require('react-transition-group/TransitionGroup'), require('recompose/pure'), require('debounce'), require('@material-ui/core/styles/withStyles'), require('@material-ui/core/ButtonBase'), require('@material-ui/core/styles/colorManipulator'), require('normalize-scroll-left'), require('scroll'), require('react-popper')) :
  typeof define === 'function' && define.amd ? define(['exports', 'deepmerge', 'jss-global', 'jss-nested', 'jss-camel-case', 'jss-default-unit', 'jss-vendor-prefixer', 'jss-props-sort', 'react', 'brcast', 'recompose/getDisplayName', 'recompose/wrapDisplayName', 'react-jss/lib/contextTypes', 'jss', 'react-jss/lib/ns', 'react-transition-group/Transition', 'react-dom', 'react-transition-group/TransitionGroup', 'recompose/pure', 'debounce', '@material-ui/core/styles/withStyles', '@material-ui/core/ButtonBase', '@material-ui/core/styles/colorManipulator', 'normalize-scroll-left', 'scroll', 'react-popper'], factory) :
  (factory((global['material-ui'] = {}),null,null,null,null,null,null,null,global.React,null,null,null,null,null,null,null,global.ReactDOM,null,null,null,null,null,null,null,null,null));
}(this, (function (exports,deepmerge,jssGlobal,jssNested,jssCamelCase,jssDefaultUnit,jssVendorPrefixer,jssPropsSort,React,createBroadcast,getDisplayName,wrapDisplayName,contextTypes,jss,ns,Transition,ReactDOM,TransitionGroup,pure,debounce,withStyles,ButtonBase,colorManipulator,normalizeScrollLeft,scroll,reactPopper) { 'use strict';

  deepmerge = deepmerge && deepmerge.hasOwnProperty('default') ? deepmerge['default'] : deepmerge;
  jssGlobal = jssGlobal && jssGlobal.hasOwnProperty('default') ? jssGlobal['default'] : jssGlobal;
  jssNested = jssNested && jssNested.hasOwnProperty('default') ? jssNested['default'] : jssNested;
  jssCamelCase = jssCamelCase && jssCamelCase.hasOwnProperty('default') ? jssCamelCase['default'] : jssCamelCase;
  jssDefaultUnit = jssDefaultUnit && jssDefaultUnit.hasOwnProperty('default') ? jssDefaultUnit['default'] : jssDefaultUnit;
  jssVendorPrefixer = jssVendorPrefixer && jssVendorPrefixer.hasOwnProperty('default') ? jssVendorPrefixer['default'] : jssVendorPrefixer;
  jssPropsSort = jssPropsSort && jssPropsSort.hasOwnProperty('default') ? jssPropsSort['default'] : jssPropsSort;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;
  createBroadcast = createBroadcast && createBroadcast.hasOwnProperty('default') ? createBroadcast['default'] : createBroadcast;
  getDisplayName = getDisplayName && getDisplayName.hasOwnProperty('default') ? getDisplayName['default'] : getDisplayName;
  wrapDisplayName = wrapDisplayName && wrapDisplayName.hasOwnProperty('default') ? wrapDisplayName['default'] : wrapDisplayName;
  contextTypes = contextTypes && contextTypes.hasOwnProperty('default') ? contextTypes['default'] : contextTypes;
  Transition = Transition && Transition.hasOwnProperty('default') ? Transition['default'] : Transition;
  var ReactDOM__default = 'default' in ReactDOM ? ReactDOM['default'] : ReactDOM;
  TransitionGroup = TransitionGroup && TransitionGroup.hasOwnProperty('default') ? TransitionGroup['default'] : TransitionGroup;
  ...
  scroll = scroll && scroll.hasOwnProperty('default') ? scroll['default'] : scroll;
  ...
  function createPalette(palette) {
    ...
    var paletteOutput = deepmerge(objectSpread({
  ...
  */
  ...
  var jss$1 = jss.create(jssPreset()); // Use a singleton or the provided one by the context.
  ...
  var withStyles$1 = function withStyles$$1(stylesOrCreator) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return function (Component) {
      ...
      function (_React$Component) {
        ...
        function WithStyles(props, context) {
          ...
          _this.unsubscribeId = null;
          _this.state = {};
          _this.jss = _this.context[ns.jss] || jss$1;
  ...
  */
  ...
  function (_React$Component) {
    ...
    createClass(Fade, [{
      ...
      value: function render() {
        ...
        var style = objectSpread({}, styleProp, React.isValidElement(children) ? children.props.style : {});
  ...
  function (_React$PureComponent) {
    ...
    function TouchRipple() {
      ...
      return possibleConstructorReturn(_this, (_temp = _this = possibleConstructorReturn(this, (_ref = TouchRipple.__proto__ || Object.getPrototypeOf(TouchRipple)).call.apply(_ref, [this].concat(args))), _this.ignoringMouseDown = false, _this.startTimer = null, _this.startTimerCommit = null, _this.state = {
        ...
        var element = fakeElement ? null : ReactDOM__default.findDOMNode(assertThisInitialized(_this));
  ...
  /*#__PURE__*/
  function (_React$Component) {
    inherits(ButtonBase$$1, _React$Component);

    function ButtonBase$$1() {
      var _ref;

      var _temp, _this;

      classCallCheck(this, ButtonBase$$1);

      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return possibleConstructorReturn(_this, (_temp = _this = possibleConstructorReturn(this, (_ref = ButtonBase$$1.__proto__ || Object.getPrototypeOf(ButtonBase$$1)).call.apply(_ref, [this].concat(args))), _this.ripple = null, _this.keyDown = false, _this.button = null, _this.focusVisibleTimeout = null, _this.focusVisibleCheckTime = 50, _this.focusVisibleMaxCheckTimes = 5, _this.handleMouseDown = createRippleHandler(assertThisInitialized(_this), 'MouseDown', 'start', function () {
    ...
    createClass(ButtonBase$$1, [{
      key: "componentDidMount",
      value: function componentDidMount() {
        var _this2 = this;

        this.button = ReactDOM__default.findDOMNode(this);
  ...
  var ButtonBase$2 = withStyles$1(styles$8, {
    name: 'MuiButtonBase'
  })(ButtonBase$1);
  ...
  function (_React$Component) {
    ...
    createClass(BottomNavigationAction, [{
      ...
      value: function render() {
        ...
        return React.createElement(ButtonBase$2, _extends_1({
          className: className,
          focusRipple: true,
  ...
  var Button$1 = withStyles$1(styles$a, {
    name: 'MuiButton'
  })(Button);
  ...
  var Card$1 = withStyles$1(styles$b, {
    name: 'MuiCard'
  })(Card);
  ...
  var CardActions$1 = withStyles$1(styles$c, {
    name: 'MuiCardActions'
  })(CardActions);
  ...
  var CardContent$1 = withStyles$1(styles$d, {
    name: 'MuiCardContent'
  })(CardContent);
  ...
  function CardHeader(props) {
    ...
    }, title$$1), subheader && React.createElement(Typography$1, {
  ...
  var CardHeader$1 = withStyles$1(styles$f, {
    name: 'MuiCardHeader'
  })(CardHeader);
  ...
  var CardMedia$1 = withStyles$1(styles$g, {
    name: 'MuiCardMedia'
  })(CardMedia);
  ...
  var SwitchBase$1 = withStyles$1(styles$i, {
    name: 'MuiSwitchBase'
  })(SwitchBase);
  ...
  function SvgIcon(props) {
    ...
    var className = classnames(classes.root, (_classNames = {}, defineProperty(_classNames, classes["fontSize".concat(capitalize(fontSize))], fontSize !== 'default'), defineProperty(_classNames, classes["color".concat(capitalize(color))], color !== 'inherit'), _classNames), classNameProp);
    return React.createElement(Component, _extends_1({
      className: className,
      focusable: "false",
      viewBox: viewBox,
  ...
  var SvgIcon$1 = withStyles$1(styles$j, {
    name: 'MuiSvgIcon'
  })(SvgIcon);
  ...
  var Checkbox$1 = withStyles$1(styles$k, {
    name: 'MuiCheckbox'
  })(Checkbox);
    ...
    createClass(Chip, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            other = objectWithoutProperties(_props, ["avatar", "classes", "className", "clickable", "component", "deleteIcon", "label", "onClick", "onDelete", "onKeyDown", "tabIndex"]);

        var className = classnames(classes.root, defineProperty({}, classes.clickable, onClick || clickable), defineProperty({}, classes.deletable, onDelete), classNameProp);
        var deleteIcon = null;
  ...
  var Chip$1 = withStyles$1(styles$l, {
    name: 'MuiChip'
  })(Chip);
  ...
  function (_React$Component) {
    ...
    createClass(ClickAwayListener, [{
      ...
      value: function render() {
        ...
        return React.createElement(EventListener, _extends_1({
          target: "document"
  ...
  var Collapse$1 = withStyles$1(styles$n, {
    withTheme: true,
    name: 'MuiCollapse'
  })(Collapse);
  ...
  var CssBaseline$1 = withStyles$1(styles$o, {
    name: 'MuiCssBaseline'
  })(CssBaseline);
  ...
  function getContainer(container, defaultContainer) {
    ...
    return ReactDOM__default.findDOMNode(container) || defaultContainer;
  }

  function getOwnerDocument(element) {
    return ownerDocument(ReactDOM__default.findDOMNode(element));
  }
  /**
  ...
  function (_React$Component) {
    ...
    createClass(Portal, [{
      ...
      value: function render() {
        ...
        return this.mountNode ? ReactDOM__default.createPortal(children, this.mountNode) : null;
      }
    }]);
  ...
  function (_React$Component) {
    ...
    function Modal(props) {
      ...
      _this = possibleConstructorReturn(this, (Modal.__proto__ || Object.getPrototypeOf(Modal)).call(this, props));
  ...
  var Modal$1 = withStyles$1(styles$p, {
    flip: false,
    name: 'MuiModal'
  })(Modal);
  ...
  function Dialog(props) {
    ...
    return React.createElement(Modal$1, _extends_1({
      className: classnames(classes.root, classes["scroll".concat(capitalize(scroll$$1))], className),
      ...
      elevation: 24,
      className: classnames(classes.paper, classes["paperScroll".concat(capitalize(scroll$$1))], (_classNames = {}, defineProperty(_classNames, classes["paperWidth".concat(maxWidth ? capitalize(maxWidth) : '')], maxWidth), defineProperty(_classNames, classes.paperFullScreen, fullScreen), defineProperty(_classNames, classes.paperFullWidth, fullWidth), _classNames))
    }, PaperProps), children)));
  }
  ...
  var Dialog$1 = withStyles$1(styles$q, {
    name: 'MuiDialog'
  })(Dialog);
  ...
  var DialogActions$1 = withStyles$1(styles$r, {
  ...
  var DialogContent$1 = withStyles$1(styles$s, {
  ...
  var DialogContentText$1 = withStyles$1(styles$t, {
  ...
  var DialogTitle$1 = withStyles$1(styles$u, {
    name: 'MuiDialogTitle'
  })(DialogTitle);
  ...
  var Divider$1 = withStyles$1(styles$v, {
    name: 'MuiDivider'
  })(Divider);
  ...
  function (_React$Component) {
    ...
    function Slide() {
      ...
      return possibleConstructorReturn(_this, (_temp = _this = possibleConstructorReturn(this, (_ref = Slide.__proto__ || Object.getPrototypeOf(Slide)).call.apply(_ref, [this].concat(args))), _this.mounted = false, _this.transition = null, _this.handleResize = debounce(function () {
        ...
        var node = ReactDOM__default.findDOMNode(_this.transition);
    ...
    createClass(Slide, [{
      ...
      value: function updatePosition() {
        var node = ReactDOM__default.findDOMNode(this.transition);
      ...
      value: function render() {
        ...
        style = objectSpread({}, style, styleProp, React.isValidElement(children) ? children.props.style : {});
  ...
  var Drawer$1 = withStyles$1(styles$w, {
    name: 'MuiDrawer',
    flip: false,
    withTheme: true
  })(Drawer);
  ...
  var ExpansionPanel$1 = withStyles$1(styles$x, {
  ...
  var ExpansionPanelActions$1 = withStyles$1(styles$y, {
  ...
  var ExpansionPanelDetails$1 = withStyles$1(styles$z, {
    ...
    createClass(ExpansionPanelSummary, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            onChange = _props.onChange,
            other = objectWithoutProperties(_props, ["children", "classes", "className", "disabled", "expanded", "expandIcon", "IconButtonProps", "onChange"]);
  ...
  var ExpansionPanelSummary$1 = withStyles$1(styles$A, {
  ...
  var Textarea$1 = withStyles$1(styles$B)(Textarea);
  ...
  function (_React$Component) {
    ...
    function FormControl(props) {
      ...
      _this = possibleConstructorReturn(this, (FormControl.__proto__ || Object.getPrototypeOf(FormControl)).call(this, props)); // We need to iterate through the children and find the Input in order
  ...
  function FormControlLabel(props, context) {
    ...
    return React.createElement("label", _extends_1({
      className: className
    }, other), React.cloneElement(control, {
      disabled: disabled,
  ...
  var FormControlLabel$1 = withStyles$1(styles$E, {
  ...
  var FormGroup$1 = withStyles$1(styles$F, {
    name: 'MuiFormGroup'
  })(FormGroup);
  ...
  var FormLabel$1 = withStyles$1(styles$H, {
    name: 'MuiFormLabel'
  })(FormLabel);
  ...
  var StyledGrid = withStyles$1(styles$I, {
    name: 'MuiGrid'
  })(Grid);
  ...
  var GridList$1 = withStyles$1(styles$J, {
    name: 'MuiGridList'
  })(GridList);
  ...
  var GridListTile$1 = withStyles$1(styles$K, {
  ...
  var GridListTileBar$1 = withStyles$1(styles$L, {
        ...
        createClass(WithWidth, [{
          ...
          value: function render() {
            ...
            return React.createElement(EventListener, {
              target: "window",
              onResize: this.handleResize
            }, React.createElement(Component, _extends_1({}, more, props)));
          }
        }]);
  ...
  var HiddenCss$1 = withStyles$1(styles$N)(HiddenCss);
  ...
  Icon.muiName = 'Icon';
  var Icon$1 = withStyles$1(styles$O, {
    name: 'MuiIcon'
  })(Icon);
  ...
  var InputAdornment$1 = withStyles$1(styles$P, {
  ...
  var LinearProgress$1 = withStyles$1(styles$R, {
  ...
  var List$1 = withStyles$1(styles$S, {
    name: 'MuiList'
  })(List);
  ...
  var ListItem$1 = withStyles$1(styles$T, {
    name: 'MuiListItem'
  })(ListItem);
  ...
  var ListItemAvatar$1 = withStyles$1(styles$U, {
  ...
  var ListItemIcon$1 = withStyles$1(styles$V, {
  ...
  var ListItemSecondaryAction$1 = withStyles$1(styles$W, {
  ...
  var ListItemText$1 = withStyles$1(styles$X, {
  ...
  var ListSubheader$1 = withStyles$1(styles$Y, {
  ...
  function (_React$Component) {
    ...
    function Popover() {
      ...
      return possibleConstructorReturn(_this, (_temp = _this = possibleConstructorReturn(this, (_ref = Popover.__proto__ || Object.getPrototypeOf(Popover)).call.apply(_ref, [this].concat(args))), _this.transitionEl = null, _this.handleGetOffsetTop = getOffsetTop, _this.handleGetOffsetLeft = getOffsetLeft, _this.handleResize = debounce(function () {
        var element = ReactDOM__default.findDOMNode(_this.transitionEl);
    ...
    createClass(Popover, [{
      ...
      value: function getAnchorOffset(contentAnchorOffset) {
        ...
        var anchorElement = getAnchorEl(anchorEl) || ownerDocument(ReactDOM__default.findDOMNode(this.transitionEl)).body;
  ...
  var Popover$1 = withStyles$1(styles$Z, {
    name: 'MuiPopover'
  })(Popover);
      ...
      return possibleConstructorReturn(_this, (_temp = _this = possibleConstructorReturn(this, (_ref = MenuList.__proto__ || Object.getPrototypeOf(MenuList)).call.apply(_ref, [this].concat(args))), _this.list = null, _this.selectedItem = null, _this.blurTimer = null, _this.state = {
        ...
        if ((key === 'up' || key === 'down') && (!currentFocus || currentFocus && !list.contains(currentFocus))) {
          if (_this.selectedItem) {
            ReactDOM__default.findDOMNode(_this.selectedItem).focus();
          } else {
    ...
    createClass(MenuList, [{
      ...
      value: function resetTabIndex() {
        ...
        if (this.selectedItem) {
          return this.setTabIndex(items.indexOf(ReactDOM__default.findDOMNode(this.selectedItem)));
        }
    ...
    function Menu() {
      ...
      return possibleConstructorReturn(_this, (_temp = _this = possibleConstructorReturn(this, (_ref = Menu.__proto__ || Object.getPrototypeOf(Menu)).call.apply(_ref, [this].concat(args))), _this.menuList = null, _this.getContentAnchorEl = function () {
        if (!_this.menuList || !_this.menuList.selectedItem) {
          return ReactDOM__default.findDOMNode(_this.menuList).firstChild;
        }

        return ReactDOM__default.findDOMNode(_this.menuList.selectedItem);
      }, _this.focus = function () {
        if (_this.menuList && _this.menuList.selectedItem) {
          ReactDOM__default.findDOMNode(_this.menuList.selectedItem).focus();
          return;
        }

        var menuList = ReactDOM__default.findDOMNode(_this.menuList);
        ...
        var _this$props = _this.props,
            ...
            theme = _this$props.theme;
        var menuList = ReactDOM__default.findDOMNode(_this.menuList); // Focus so the scroll computation of the Popover works as expected.
    ...
    createClass(Menu, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            theme = _props.theme,
            other = objectWithoutProperties(_props, ["children", "classes", "disableAutoFocusItem", "MenuListProps", "onEnter", "PaperProps", "PopoverClasses", "theme"]);
  ...
  var Menu$1 = withStyles$1(styles$_, {
    name: 'MuiMenu',
    withTheme: true
  })(Menu);
  ...
  var MenuItem$1 = withStyles$1(styles$10, {
    name: 'MuiMenuItem'
  })(MenuItem);
  ...
  function MobileStepper(props) {
    ...
    })), variant === 'progress' && React.createElement(LinearProgress$1, {
  ...
  var MobileStepper$1 = withStyles$1(styles$11, {
  ...
  var NativeSelect$1 = withStyles$1(styles$12, {
  ...
  var Radio$1 = withStyles$1(styles$13, {
    name: 'MuiRadio'
  })(Radio);
    ...
    createClass(SelectInput, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            value = _props.value,
            other = objectWithoutProperties(_props, ["autoWidth", "children", "classes", "className", "disabled", "displayEmpty", "IconComponent", "inputRef", "MenuProps", "multiple", "name", "onBlur", "onChange", "onClose", "onFocus", "onOpen", "open", "readOnly", "renderValue", "required", "SelectDisplayProps", "tabIndex", "type", "value"]);
  ...
  var Select$1 = withStyles$1(styles$12, {
    name: 'MuiSelect'
  })(Select);
  ...
  var style = function style(theme) {
    ...
    return {
      ...
      thumb: {
        ...
        backgroundColor: colors.primary,
        '&$focused': {
          boxShadow: "0px 0px 0px 9px ".concat(colorManipulator.fade(colors.primary, 0.16))
        },
        '&$activated': {
          width: 17,
          height: 17,
        ...
        '&$focused$zero': {
          ...
          backgroundColor: colorManipulator.fade(colors.focused, 0.34),
          boxShadow: "0px 0px 0px 9px ".concat(colorManipulator.fade(colors.focused, 0.34))
        },
        '&$activated$zero': {
          border: "2px solid ".concat(colors.focused)
        },
  ...
  function calculatePercent(node, event, isVertical, isReverted) {
    ...
    return isReverted ? 100 - clamp$1(value / onePercent) : clamp$1(value / onePercent);
  }
  ...
  function (_React$Component) {
    ...
    function Slider() {
      ...
      return possibleConstructorReturn(_this, (_temp = _this = possibleConstructorReturn(this, (_ref = Slider.__proto__ || Object.getPrototypeOf(Slider)).call.apply(_ref, [this].concat(args))), _this.state = {
    ...
    createClass(Slider, [{
      ...
      value: function render() {
        ...
        var _props2 = this.props,
            ...
            other = objectWithoutProperties(_props2, ["component", "classes", "className", "disabled", "max", "min", "reverse", "theme", "value", "vertical"]);

        var percent = clamp$1((value - min) * 100 / (max - min));
        var commonClasses = (_commonClasses = {}, defineProperty(_commonClasses, classes.disabled, disabled), defineProperty(_commonClasses, classes.jumped, !disabled && currentState === 'jumped'), defineProperty(_commonClasses, classes.focused, !disabled && currentState === 'focused'), defineProperty(_commonClasses, classes.activated, !disabled && currentState === 'activated'), _commonClasses);
        var rootClasses = classnames(classes.root, (_classNames = {}, defineProperty(_classNames, classes.vertical, vertical), defineProperty(_classNames, classes.reverse, reverse), defineProperty(_classNames, classes.disabled, disabled), _classNames), classNameProp);
        var containerClasses = classnames(classes.container, defineProperty({}, classes.vertical, vertical), classNameProp);
        var trackBeforeClasses = classnames(classes.track, classes.trackBefore, commonClasses, defineProperty({}, classes.vertical, vertical));
        var trackAfterClasses = classnames(classes.track, classes.trackAfter, commonClasses, defineProperty({}, classes.vertical, vertical));
        var thumbClasses = classnames(classes.thumb, commonClasses, defineProperty({}, classes.zero, percent === 0));
        var trackProperty = vertical ? 'height' : 'width';
        var thumbProperty = vertical ? 'top' : 'left';

        var inlineTrackBeforeStyles = defineProperty({}, trackProperty, this.calculateTrackBeforeStyles(percent));

        var inlineTrackAfterStyles = defineProperty({}, trackProperty, this.calculateTrackAfterStyles(percent));

        var inlineThumbStyles = defineProperty({}, thumbProperty, "".concat(percent, "%"));
        ...
        return React.createElement(Component, _extends_1({
          ...
          ref: function ref(node) {
            _this3.container = ReactDOM.findDOMNode(node);
          }
        }, other), React.createElement("div", {
  ...
  var SnackbarContent$1 = withStyles$1(styles$15, {
  ...
  var Snackbar$1 = withStyles$1(styles$16, {
    flip: false,
    name: 'MuiSnackbar'
  })(Snackbar);
  ...
  var Step$1 = withStyles$1(styles$17, {
    name: 'MuiStep'
  })(Step);
  ...
  var StepIcon$1 = withStyles$1(styles$18, {
    name: 'MuiStepIcon'
  })(StepIcon);
  ...
  var StepLabel$1 = withStyles$1(styles$19, {
    name: 'MuiStepLabel'
  })(StepLabel);
  ...
  function Stepper(props) {
    ...
    var steps = childrenArray.map(function (step, index) {
      ...
      }), React.cloneElement(step, objectSpread({}, controlProps, step.props))];
    });
    return React.createElement(Paper$1, _extends_1({
      square: true,
      elevation: 0,
  ...
  var SwipeArea$1 = withStyles$1(styles$1e)(SwipeArea);
  ...
  function (_React$Component) {
    ...
    function SwipeableDrawer() {
      ...
      return possibleConstructorReturn(_this, (_temp = _this = possibleConstructorReturn(this, (_ref = SwipeableDrawer.__proto__ || Object.getPrototypeOf(SwipeableDrawer)).call.apply(_ref, [this].concat(args))), _this.backdrop = null, _this.paper = null, _this.isSwiping = null, _this.startX = null, _this.startY = null, _this.state = {}, _this.handleBodyTouchStart = function (event) {
        ...
        _this.backdrop = node ? ReactDOM__default.findDOMNode(node) : null;
      }, _this.handlePaperRef = function (node) {
        _this.paper = node ? ReactDOM__default.findDOMNode(node) : null;
      }, _temp));
    }
    ...
    createClass(SwipeableDrawer, [{
      ...
      value: function render() {
        ...
        }, other)), !disableDiscovery && !disableSwipeToOpen && variant === 'temporary' && React.createElement(SwipeArea$1, {
          anchor: other.anchor,
  ...
  var Table$1 = withStyles$1(styles$1g, {
    name: 'MuiTable'
  })(Table);
  ...
  var TableBody$1 = withStyles$1(styles$1h, {
    name: 'MuiTableBody'
  })(TableBody);
  ...
  var TableCell$1 = withStyles$1(styles$1i, {
    name: 'MuiTableCell'
  })(TableCell);
  ...
  var TableFooter$1 = withStyles$1(styles$1j, {
    name: 'MuiTableFooter'
  })(TableFooter);
  ...
  var TableHead$1 = withStyles$1(styles$1k, {
    name: 'MuiTableHead'
  })(TableHead);
  ...
  var Toolbar$1 = withStyles$1(styles$1l, {
    name: 'MuiToolbar'
  })(Toolbar);
    ...
    createClass(TablePaginationActions, [{
      ...
      value: function render() {
        ...
        return React.createElement("div", other, React.createElement(IconButton$1, _extends_1({
          ...
          disabled: page === 0
        }, backIconButtonProps), theme.direction === 'rtl' ? _ref2$1 : _ref3), React.createElement(IconButton$1, _extends_1({
  ...
  var TablePagination$1 = withStyles$1(styles$1m, {
  ...
  var TableRow$1 = withStyles$1(styles$1n, {
    name: 'MuiTableRow'
  })(TableRow);
  ...
  var ArrowDownward = function ArrowDownward(props) {
    return React.createElement(SvgIcon$1, props, _ref$d);
  };
  ...
  var TableSortLabel$1 = withStyles$1(styles$1o, {
  ...
  var TabIndicator$1 = withStyles$1(styles$1q)(TabIndicator);
  ...
  var _ref$e = React.createElement(KeyboardArrowLeft$1, null);
  ...
  function TabScrollButton(props) {
    ...
    return React.createElement(ButtonBase$2, _extends_1({
      ...
      onClick: onClick,
      tabIndex: -1
    }, other), direction === 'left' ? _ref$e : _ref2$2);
  }
  ...
  var TabScrollButton$1 = withStyles$1(styles$1r, {
      ...
      return possibleConstructorReturn(_this, (_temp = _this = possibleConstructorReturn(this, (_ref = Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call.apply(_ref, [this].concat(args))), _this.tabs = null, _this.valueToIndex = new Map(), _this.handleResize = debounce(function () {
        ...
        if (_this.tabs) {
          ...
          tabsMeta = {
            ...
            scrollLeftNormalized: _this.tabs ? normalizeScrollLeft.getNormalizedScrollLeft(_this.tabs, direction) : 0,
        ...
        if (_this.tabs) {
          ...
          var invert = theme.direction === 'rtl' && normalizeScrollLeft.detectScrollType() === 'reverse' ? -1 : 1;
        ...
        if (_this.tabs && scrollable && scrollButtons !== 'off') {
          ...
          var scrollLeft = normalizeScrollLeft.getNormalizedScrollLeft(_this.tabs, theme.direction);
    ...
    createClass(Tabs, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            theme = _props.theme,
            value = _props.value,
            other = objectWithoutProperties(_props, ["action", "centered", "children", "classes", "className", "component", "fullWidth", "indicatorColor", "onChange", "scrollable", "ScrollButtonComponent", "scrollButtons", "TabIndicatorProps", "textColor", "theme", "value"]);
  ...
  var Tabs$1 = withStyles$1(styles$1s, {
    name: 'MuiTabs',
    withTheme: true
  })(Tabs);
  ...
  function (_React$Component) {
    ...
    createClass(Tooltip, [{
      ...
      value: function render() {
        ...
        return React.createElement(reactPopper.Manager, _extends_1({
          tag: false
        }, other), React.createElement(EventListener, {
          target: "window",
          onResize: this.handleResize
        }), React.createElement(reactPopper.Target, null, function (_ref) {
        ...
        }), React.createElement(Portal, null, React.createElement(reactPopper.Popper, _extends_1({
          placement: placement,
          eventsEnabled: open,
          ...
          return React.createElement("div", _extends_1({}, popperProps, restProps, {
  ...
  exports.ButtonBase = ButtonBase$2;
  exports.Card = Card$1;
